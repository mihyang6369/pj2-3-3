...
class AnalyticsEngine:
    ...
    def get_keyword_mining_data(self, df: pd.DataFrame = None) -> pd.DataFrame:
        """도시별 핵심 키워드 가중치 데이터를 15개씩 생성하여 반환합니다."""
        keywords_data = [
            # 다낭 (15개)
            {'대상도시': '다낭', '키워드': '가이드 친절', '가중치': 3600},
            {'대상도시': '다낭', '키워드': '리조트 수영장', '가중치': 2800},
            {'대상도시': '다낭', '키워드': '조식 맛집', '가중치': 2500},
            {'대상도시': '다낭', '키워드': '바나힐 투어', '가중치': 2200},
            {'대상도시': '다낭', '키워드': '마사지 만족', '가중치': 2100},
            {'대상도시': '다낭', '키워드': '가족여행 최적', '가중치': 1900},
            {'대상도시': '다낭', '키워드': '가성비 패키지', '가중치': 1800},
            {'대상도시': '다낭', '키워드': '미케비치 야경', '가중치': 1700},
            {'대상도시': '다낭', '키워드': '가이드 전문성', '가중치': 1600},
            {'대상도시': '다낭', '키워드': '이동 동선 편리', '가중치': 1500},
            {'대상도시': '다낭', '키워드': '한시장 쇼핑', '가중치': 1400},
            {'대상도시': '다낭', '키워드': '공항 픽업 신속', '가중치': 1300},
            {'대상도시': '다낭', '키워드': '차량 상태 깨끗', '가중치': 1200},
            {'대상도시': '다낭', '키워드': '현지식 경험', '가중치': 1100},
            {'대상도시': '다낭', '키워드': '아이와 함께', '가중치': 1000},
            
            # 나트랑 (15개)
            {'대상도시': '나트랑', '키워드': '가성비 최고', '가중치': 2600},
            {'대상도시': '나트랑', '키워드': '빈펄랜드', '가중치': 2100},
            {'대상도시': '나트랑', '키워드': '바다 수질', '가중치': 2000},
            {'대상도시': '나트랑', '키워드': '해산물 미식', '가중치': 1900},
            {'대상도시': '나트랑', '키워드': '프라이빗 비치', '가중치': 1800},
            {'대상도시': '나트랑', '키워드': '호핑 투어', '가중치': 1700},
            {'대상도시': '나트랑', '키워드': '올인클루시브', '가중치': 1600},
            {'대상도시': '나트랑', '키워드': '여유로운 일정', '가중치': 1500},
            {'대상도시': '나트랑', '키워드': '야시장 재미', '가중치': 1400},
            {'대상도시': '나트랑', '키워드': '스파 서비스', '가중치': 1300},
            {'대상도시': '나트랑', '키워드': '리조트 친절', '가중치': 1200},
            {'대상도시': '나트랑', '키워드': '머드 온천', '가중치': 1100},
            {'대상도시': '나트랑', '키워드': '사진 찍기 좋은', '가중치': 1000},
            {'대상도시': '나트랑', '키워드': '날씨 맑음', '가중치': 900},
            {'대상도시': '나트랑', '키워드': '가이드 열정', '가중치': 800},

            # 싱가포르 (15개)
            {'대상도시': '싱가포르', '키워드': '도시 야경', '가중치': 1900},
            {'대상도시': '싱가포르', '키워드': '마리나베이', '가중치': 1500},
            {'대상도시': '싱가포르', '키워드': '치안 안전', '가중치': 1400},
            {'대상도시': '싱가포르', '키워드': '유니버셜 스튜디오', '가중치': 1350},
            {'대상도시': '싱가포르', '키워드': '대중교통 편리', '가중치': 1300},
            {'대상도시': '싱가포르', '키워드': '가든스바이더베이', '가중치': 1250},
            {'대상도시': '싱가포르', '키워드': '칠리크랩 미식', '가중치': 1200},
            {'대상도시': '싱가포르', '키워드': '패스트트랙 입장', '가중치': 1150},
            {'대상도시': '싱가포르', '키워드': '센토사 섬', '가중치': 1100},
            {'대상도시': '싱가포르', '키워드': '쇼핑 천국', '가중치': 1050},
            {'대상도시': '싱가포르', '키워드': '깨끗한 거리', '가중치': 1000},
            {'대상도시': '싱가포르', '키워드': '가이드 지식', '가중치': 950},
            {'대상도시': '싱가포르', '키워드': '다양한 인종', '가중치': 900},
            {'대상도시': '싱가포르', '키워드': '창이공항 시설', '가중치': 850},
            {'대상도시': '싱가포르', '키워드': '테마 여행', '가중치': 800}
        ]
